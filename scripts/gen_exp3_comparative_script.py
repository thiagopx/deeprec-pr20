...
python -m comparison.liang --dataset D1 --soft-path {} --num-threads 48
python -m comparison.liang --dataset D2 --soft-path {} --num-threads 48

export OMP_NUM_THREADS=12
python -m comparison.liang --dataset D1 --soft-path {} --num-threads 12
python -m comparison.liang --dataset D2 --soft-path {} --num-threads 12

export OMP_NUM_THREADS=1
python -m comparison.liang --dataset D1 --soft-path {} --num-threads 1
python -m comparison.liang --dataset D2 --soft-path {} --num-threads 1
'''.format(* (6 * [CONFIG_DIR_DOCREASSEMBLY]))

open('scripts/exp3_comparative.sh', 'w').write(txt)
