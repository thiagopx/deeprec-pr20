...
datasets = ["D1", "D2", "cdip"]
template_fname = "results/exp2_ablation/{}_0.2_1000_32x32_{}.json"
records = []
...
leg = last_ax.legend(
    title="$v_{shift}$", loc="center left", bbox_to_anchor=(1.0, 0.5), fontsize=90, title_fontsize=100, labelspacing=0.1
)
