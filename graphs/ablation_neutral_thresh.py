...
fp.add_legend(title='$\\rho_{black}$',  prop={'size': 120}, labelspacing=0.1)
...
plt.savefig('{}/ablation_neutral_thresh.pdf'.format(path), bbox_inches='tight')